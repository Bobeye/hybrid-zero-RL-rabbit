...
register(
    id='RabbitAdv-v0',
    entry_point='gym.envs.adversarial.mujoco:RabbitEnv',
    reward_threshold=11950.0,
)
...
register(
    id='PendulumCustomize-v0',
    entry_point='gym.envs.classic_control:PendulumCustomizeEnv',
    max_episode_steps=200,
)
...
register(
    id='SwimmerCustomize-v1',
    entry_point='gym.envs.mujoco:SwimmerCustomizeEnv',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
